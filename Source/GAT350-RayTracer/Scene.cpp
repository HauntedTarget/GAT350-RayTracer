...
namespace nc
{
	...
	nc::Color::color3_t Scene::Trace(const ray_t& ray, float minDistance, float maxDistance, raycastHit_t& raycastHit)
	{
		bool rayHit = false;
		...
		Color::color3_t color = lerp(m_bottomColor, m_topColor, t);
